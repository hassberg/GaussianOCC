...
class NoiseLogger(EvaluationMetric):
    """
    ...
    def append_round_scoring(self):
        self.iteration_scoring.append(self.surrogate_model.gaussian_process_model.likelihood.noise_covar.raw_noise.T.detach().numpy().flatten()[0])
