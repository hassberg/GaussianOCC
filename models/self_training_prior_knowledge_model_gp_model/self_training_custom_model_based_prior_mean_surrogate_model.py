...
from models.self_training_prior_knowledge_model_gp_model.self_training_custom_model_prior_gaussian_process import SelfTrainingCustomModelBasedGaussianProcess


class SelfTrainingCustomModelBasedPriorMeanSurrogateModel(SurrogateModel):
    ...
    def post_init(self, data_retriever):
        ...
        self.gaussian_process_model = SelfTrainingCustomModelBasedGaussianProcess(self.model_parameter["init_points"],
